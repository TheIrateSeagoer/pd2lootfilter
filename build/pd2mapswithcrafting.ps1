...
'.\obj\catchall.filter', '.\obj\catchall.maps.filter' | Set-Content '.\bin\maps-with-crafting.filter'

Copy-Item '.\bin\maps-with-crafting.filter' -Destination '..\maps-with-crafting.filter'
